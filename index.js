...
const Home = () => {
  ...
  useEffect(() => {
    // Simulating the fetching of NFTs with static data
    const fetchedNFTs = [
      { tokenId: 1, name: "NFT 1", price: 1.2 },
      { tokenId: 2, name: "NFT 2", price: 0.8 },
      { tokenId: 3, name: "NFT 3", price: 2.3 },
    ];
    setNfts(fetchedNFTs);
  ...
  return (
    <div className="flex justify-center sm:px-4 p-12 bg-custom-dark-green">
